...
const CONFIG = {
  ...
  quote: {
    ...
    text: "Wahai manusia, sesungguhnya Kami telah menciptakan kamu dari seorang laki-laki dan perempuan. Kemudian, Kami menjadikan kamu berbangsa-bangsa dan bersuku-suku agar kamu saling mengenal. Sesungguhnya yang paling mulia di antara kamu di sisi Alloh adalah orang yang paling bertakwa. Sesungguhnya Alloh Maha Mengetahui lagi Maha teliti.",
